...
// default values set.
func (c *GraphiteConfig) WithDefaults() *GraphiteConfig {
	d := *c
	if d.BindAddress == "" {
...
func (c *GraphiteConfig) DefaultTags() models.Tags {
...
func (c *GraphiteConfig) validateTemplates() error {
...
func (c *GraphiteConfig) validateTags() error {
	for _, t := range c.Tags {
...
func (c *GraphiteConfig) validateTemplate(template string) error {
...
func (c *GraphiteConfig) validateFilter(filter string) error {
...
func (c *GraphiteConfig) validateTag(keyValue string) error {
